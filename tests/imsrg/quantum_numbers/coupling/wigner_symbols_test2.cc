...
// Do not merge with other wigner_symbols test file.
// This requires no OpenMPRuntime initialization to happen.
...
TEST_CASE("Test calculated Wigner 3J symbols relative to stored values.") {
  ...
  REQUIRE_FALSE(imsrg::OpenMPRuntime::IsInitialized());
