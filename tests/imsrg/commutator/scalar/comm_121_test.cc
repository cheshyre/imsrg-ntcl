...
TEST_CASE("Test emax=4 NAT O16 [1, 2] -> 1 commutator (anti-herm, herm).") {
  ...
  SECTION("[gen1, h2]") {
    ...
    std::string path_to_result_me1j =
        ...
        "calc_emax_04/"
        "HNO_O16_NN-only_EMN500_N3LO_NAT_mf_calc_emax_04_hw_24.00_emax_04_"
        "imaginary-time_Moller_Plesset_comm12X_gen1_ham2.me1j";
    ...
    imsrg::EvaluateScalar121Commutator(gen1, h2, actual_result);
  ...
  SECTION("[h2, gen1]") {
    ...
    std::string path_to_result_me1j =
        ...
        "calc_emax_04/"
        "HNO_O16_NN-only_EMN500_N3LO_NAT_mf_calc_emax_04_hw_24.00_emax_04_"
        "imaginary-time_Moller_Plesset_comm21X_ham2_gen1.me1j";
    const auto result_me1j = ME1JFile::FromTextFile(path_to_result_me1j, emax,
                                                    Hermiticity::Hermitian());

    imsrg::ReadOperatorFromME1J(result_me1j, expected_result);

    imsrg::EvaluateScalar211Commutator(h2, gen1, actual_result);
  ...
  SECTION("[h1, gen2]") {
    ...
    std::string path_to_result_me1j =
        ...
        "calc_emax_04/"
        "HNO_O16_NN-only_EMN500_N3LO_NAT_mf_calc_emax_04_hw_24.00_emax_04_"
        "imaginary-time_Moller_Plesset_comm12X_ham1_gen2.me1j";
    const auto result_me1j = ME1JFile::FromTextFile(path_to_result_me1j, emax,
                                                    Hermiticity::Hermitian());

    imsrg::ReadOperatorFromME1J(result_me1j, expected_result);

    imsrg::EvaluateScalar121Commutator(h1, gen2, actual_result);
  ...
  SECTION("[gen2, h1]") {
    ...
    std::string path_to_result_me1j =
        ...
        "calc_emax_04/"
        "HNO_O16_NN-only_EMN500_N3LO_NAT_mf_calc_emax_04_hw_24.00_emax_04_"
        "imaginary-time_Moller_Plesset_comm21X_gen2_ham1.me1j";
    const auto result_me1j = ME1JFile::FromTextFile(path_to_result_me1j, emax,
                                                    Hermiticity::Hermitian());

    imsrg::ReadOperatorFromME1J(result_me1j, expected_result);

    imsrg::EvaluateScalar211Commutator(gen2, h1, actual_result);
